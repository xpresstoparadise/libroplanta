...
<xsl:template match="externalPubIssueDate">
  ...
  <xsl:template match="  simplePara|  notePara|  warningAndCautionPara|  attentionListItemPara|  restrictionInstructions|  restrictionInfo|  dataDistribution|  dataHandling|  dataDestruction|  dataDisclosure|  dataConds|  policyStatement|  captionText|  captionLine|  supersedure|  exportRegistrationCode">
    <Section>
      <xsl:call-template name="idtemplate" />
      <Paragraph>
        <Span Id="ChildrenAttributesContainer">
